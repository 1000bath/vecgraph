import type { MemoryStoreEntry, MemoryType, AutoMaintenanceOptions, ReanchorResult, RememberOptions } from "./adapter.js";
import type { AnchorVerificationReport, MemoryAnchor } from "./anchors.js";
...
export interface MemoryPort {
  ...
  getGraphView?(opts?: { limit?: number; includeIsolated?: boolean }): Promise<import("./entityGraph.js").GraphView>;

  /** One entity with its relations and mentioning memories. */
  getGraphEntity?(name: string): Promise<import("./entityGraph.js").EntityDetail | null>;

  /** Entities ordered by connectedness. */
  listGraphEntities?(limit?: number): Promise<Array<import("./entityGraph.js").Entity & { degree: number }>>;
